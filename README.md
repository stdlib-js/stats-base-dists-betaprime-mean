...
```javascript
import mean from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-betaprime-mean@v0.3.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-betaprime-mean/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/stats-base-dists-betaprime-mean/actions/workflows/test.yml?query=branch:v0.3.0
